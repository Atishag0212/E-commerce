            ...
            <div id="container">
                ...
                <div id="shopName"><a href="index.html" style="font-size: 30px;"> <b style="font-size: 30px;">FASHION</b>HUB</a></div>
                    ...
                    <div id="search">
                     ...
                     <div id="newdiv">
                         <div id="clothing"><a href="mainpage.jsp"><b> HOME </b></a></div>
                        <div id="clothing"><a href="myaccount.jsp"><b> MY ACCOUNT </b></a></div>
                        <div id="clothing"><a href="orderdetail.jsp"><b> ORDER DETAILS </b></a></div>
                        <div id="accessories"><a href="about.jsp"><b> ABOUT </b></a></div>
                    ...
                    <div id="user">
                        ...
                        <a href="destroysession.jsp" style="width: 50px; text-decoration: none"><b>SIGN OUT</b></a>
                    </div>
            </div>
