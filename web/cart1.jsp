<html>
     <form action="JavacodeInsertCart.jsp" id="forms">
        <input type="text" name="pname" id="pname"style="display: none">
        <input type="text" name="price"id="price" style="display: none">
        <input type="submit"value="Confirm Order" id="btn1">
     </form>
</html>
<script>
 console.clear();
...
function dynamicCartSection(ob,itemCounter)
{
    ...
    document.getElementById("pname").value=ob.name;
...
buttonLink.href = 'orderPlaced.jsp?'
